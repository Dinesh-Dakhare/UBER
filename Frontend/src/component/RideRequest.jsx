...
const RideRequest = ({setRideRequestOpen,setRideDataClose,setConfirmRide,ride,acceptRide}) => {
 if(!ride){
   return null;
 }
const {pickup,destination,fare,user:{fullname:{firstname,lastname}}}=ride
  ...
  return (
    ...
    <div >
      ...
      <div className="flex gap-4 justify-end">
        <button className=" px-2 py-1 rounded-sm bg-slate-200">ignore</button>
        <button  className=" px-2 py-1 rounded-sm bg-yellow-300" onClick={()=>{setConfirmRide(true); acceptRide(); setRideRequestOpen(false)}}>Accept</button>
      </div>
    </div>
    </div>
  );
