    ...
    <div className="space-y-6 ">
      <div className="flex justify-between p-4">
        ...
        <div>
          ...
          <p className="font-baseline">2.2km</p>
        </div>
      </div>
      <div className="space-y-6 px-6 py-2">
        ...
        <form action="" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            <button className=" px-2 py-1 rounded-sm w-full bg-yellow-300">
              Confirm
            </button>
            <button
              className=" px-2 py-1 rounded-sm w-full bg-slate-200"
              onClick={() => {
                setConfirmRide(false), setRideRequestOpen(false);
              }}
            >
              Cancel
            </button>
